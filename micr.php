...
<?php include "navbar.php"; ?>
    <div class="text-center" style="margin-top: 68px;"><img class="img-fluid" src="assets/img/head.jpg" style="background-size: auto;background-repeat: no-repeat;">
        <h2 class="text-center shadow" style="height: 45px;"><i class="fa fa-bank" style="margin-right:8px;"></i>Search By MICR</h2>
    </div>
    <div class="row no-gutters justify-content-center">
        ...
        <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8" style="margin-bottom: 11px;">
            <div style="background-color: #ffffff;max-height: 100%;height: 98%;">
                <form method="POST" class="text-center border rounded shadow" style="width: auto;margin-top: 10px;margin-right: 5px;margin-left: 5px;max-width: 100%;min-width: 343px;padding: 8px;background-color: #f2f2f2;max-height: 100%;height: 100%;margin-bottom: 10px;padding-top: 35px;padding-bottom: 35px;">
                <?php
                ...
                if(isset($_POST["submit"]))
                {
                    ...
                    $st = "SELECT * FROM `neft` WHERE `micr`='$micr'";
                    ...
                    if($result->num_rows> 0) 
                    {
                     ...
                     {
                        echo '<h5 style="margin-bottom: 25px;">Search Bank Details By MICR</h5>';
                     }
                   
                ?>
          
                    <input class="form-control mx-auto" id="micr" name="micr" type="text" style="max-width: 335px;margin-bottom: 10px;" placeholder="Enter MICR number" required="">
                    <div id="alert">
                        <?php
                    if(isset($_POST["submit"]))
                    {
                        ...
                        elseif(isset($_GET["i"]))
                        {
                        $str="*MICR code is invalid, it should contain minimum 9 characters";
